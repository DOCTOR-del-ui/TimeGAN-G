...
def load_data(opt):
  ## Data loading
  if opt.data_name.startswith("cmapsst"):
    data_name = opt.data_name
    data_path = os.path.join("data", f"{data_name}.npz")
    ori_data = np.load(data_path)["data"]
    ori_data = [x for x in ori_data]
  elif opt.data_name in ['stock', 'energy']:
